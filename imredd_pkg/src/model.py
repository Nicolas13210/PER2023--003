...
class Model_classif_1(nn.Module):
    def __init__(self):
        ...
        # self.dense3 = torch.nn.Linear(128, 7, bias=True).cuda()
        ...
        self.dense3 = torch.nn.Linear(128, 7, bias=True)
...
class Model_classif_1_gpu(nn.Module):
    def __init__(self):
        super(Model_classif_1_gpu, self).__init__()
...
def get_mobilenet_classif_1(gpu=False):
    # Create an instance of the model and move it to the GPU if available
    if gpu:
        model = Model_classif_1_gpu()
    else:
